...
A new benchmarking feature demanded an anonymised view of hundreds of millions of expenditure rows 
across the platform — no tooling existed, and the implementation approach was deliberately left 
open.
...
hash/binary-search indexing, vector embeddings for semantic search, an evaluation agent pattern for AI
sanity checks, and crosswalk construction between source and target taxonomies.
